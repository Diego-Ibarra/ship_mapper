...
.. _1_run.py: https://github.com/Diego-Ibarra/ship_mapper/blob/master/examples/projects/example1_Maritimes_AIS/1_run.py
.. _make_basemap.py: https://github.com/Diego-Ibarra/ship_mapper/blob/master/examples/grids/Maritimes/make_basemap.py
.. _make_info.py: https://github.com/Diego-Ibarra/ship_mapper/blob/master/examples/projects/example1_Maritimes_AIS/make_info.py


Executing 1_run.py_ (shown below) will produce the following map.

.. image:: ./_images/example1_Maritimes_AIS.png
   :target: _images/example1_Maritimes_AIS.png
   :align: center
